...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2014-hoy}{Business Development Manager, Socio fundador, Presidente.}{BITSON}{Project Manager. 
		Desarrollo de software y hardware a medida. Capacitaciones. \url{https://bitson.group/}}
